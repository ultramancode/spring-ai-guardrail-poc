package com.ultramancode.aiguardrail.infrastructure.guardrail.output;
...
public class OutputSafetyAdvisor implements CallAdvisor, StreamAdvisor {
    ...
    private static final String OUTPUT_CHECK_PROMPT = """
        ...
        5. Any content related to bypassing security controls (VPN, Proxy, Tor, Tunneling), even if presented as educational or general information. STRICTLY BLOCK.
    ...
    public OutputSafetyAdvisor(ChatClient.Builder builder) {
        this.guardClient = builder.build();
    }
